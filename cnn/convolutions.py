...
# Sobel kernels can be used to detect edge-like regions along both the x and y-axis,
...
for (kernelName, K) in kernelBank:
    ...
    # OpenCV’s much more optimized version of our convolve
    # function. for sanity check our custom implementation.
